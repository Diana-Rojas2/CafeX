    ...
    <>
      ...
      <main className="my-8">
        <div className="container mx-auto px-6">
          {session ? <Correo></Correo> : <p>Sesion no iniciada</p>}
            ...
            <div className="bg-gray-900 bg-opacity-50 flex items-center h-full">
              <div className="px-10 max-w-xl">
                ...
                <p className="mt-2 text-gray-400 text-justify">
                  ...
                  provident! Rerum esse expedita quidem, eveniet soluta
                  similique illo dicta, saepe suscipit quo iure, natus accusamus
                  debitis voluptatibus aliquam minima ad?
                </p>
              ...
              <div className="bg-gray-900 bg-opacity-50 flex items-center h-full">
                <div className="px-10 max-w-xl">
                  ...
                  <p className="mt-2 text-gray-400 text-justify">
                    ...
                    itaque aliquid laudantium enim numquam repellat consequuntur
                    nesciunt excepturi fugiat animi!
                  </p>
