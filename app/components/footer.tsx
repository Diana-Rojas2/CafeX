      ...
      <div className="container px-5 mx-auto">
        <div className="flex flex-row items-center text-center">
          ...
          <div className="flex flex-row items-center">
            <a className="flex items-center space-x-3 hover:text-orange-400 transition dark:text-white m-2">
              <svg
            ...
            <a className="flex items-center space-x-3 hover:text-red-600 transition dark:text-white  m-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="w-5"
            ...
            <a
              className="flex items-center space-x-3 hover:text-sky-400 transition dark:text-white  m-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
            ...
            <a className="flex items-center space-x-3 hover:text-purple-400 transition dark:text-white  m-2">
