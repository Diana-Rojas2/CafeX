  ...
  return (
    <div className="bg-[#a2b38b] border-gray-200 dark:bg-gray-900" ref={node}>
      ...
      <nav
        ...
        >
          <div className="  bg-[#a2b38b] dark:bg-gray-900 flex flex-col sm:flex-row p-2 md:p-0 mt-2 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:dark:bg-gray-900 dark:border-gray-700">
            <Link
